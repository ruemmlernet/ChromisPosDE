...
public final class PaymentsEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    private final String m_GvTypIn[] = {"Privateinlage", "Geldtransit", "Einzahlung", "Anfangsbestand", "DifferenzSollIst"};
    private final String m_GvTypOut[] = {"Geldtransit", "Privatentnahme", "Lohnzahlung", "Auszahlung", "DifferenzSollIst"};
    ...
    public Object createValue() throws BasicException {
        ...
        payment[7] = m_jGvTyp.getSelectedItem().toString();
        payment[8] = m_App.getAppUserView().getUser().getUserInfo().getId();
        return payment;
    }
    ...
    private void initComponents() {
        ...
        m_jGvTyp = new javax.swing.JComboBox();
        ...
        jLabel6.setText("Geschäftsvorfall (*)");
        jLabel6.setToolTipText("gemäß DSFinV-K: GV_TYP - Geschäftsvorfalltypen");

        m_jGvTyp.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        m_jGvTyp.setFocusable(false);
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(m_jGvTyp, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(m_jGvTyp, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void m_jreasonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jreasonActionPerformed
        ...
        Integer selected = m_jreason.getSelectedIndex();
        switch (selected) {
            case 0:         // Bar Einzahlung
                m_jGvTyp.removeAllItems();
                for (String ii: m_GvTypIn) {
                    m_jGvTyp.addItem(ii);
                }
                break;
            case 1:         // Bar Auszahlung
                m_jGvTyp.removeAllItems();
                for (String ii: m_GvTypOut) {
                    m_jGvTyp.addItem(ii);
                }
                break;
        }
    ...
    private javax.swing.JComboBox m_jGvTyp;
