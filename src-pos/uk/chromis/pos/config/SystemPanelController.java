...
public class SystemPanelController implements Initializable, BaseController {
    ...
    @FXML
    private LabeledToggleSwitch roundTicketline;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        dirty.bindBidirectional(roundTicketline.dirty);
        ...
        roundTicketline.setLabelWidth(175.0);
        roundTicketline.setText(AppLocal.getIntString("label.roundTicketline"));
    ...
    public void load() {
        ...
        roundTicketline.setSelected(AppConfig.getInstance().getBoolean("ticketline.roundvalues"));
    ...
    public void save() {
        ...
        AppConfig.getInstance().setBoolean("ticketline.roundvalues", roundTicketline.isSelected());
