...
public class ConfigurationController implements Initializable {
    ...
    private TsePanelController tseController;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        tseController = (TsePanelController) getController(configureTSE, "/uk/chromis/pos/config/TsePanel.fxml");
        // sync
        ...
        dirty.bindBidirectional(tseController.dirty);
