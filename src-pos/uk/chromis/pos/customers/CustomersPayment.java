...
public class CustomersPayment extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {
    ...
    public CustomersPayment() {
        ...
        m_jDeposit.addEditorKeys(m_jKeys);
    ...
    private void editCustomer(CustomerInfoExt customer) {
        ...
        if (customer.getCurdebt() < 0) {
            m_jDeposit.setDoubleValue(0.0);
        } else {
            m_jDeposit.setDoubleValue(customer.getCurdebt());
        }
...
//        btnPay.setEnabled(customer.getCurdebt() != null && m_jDeposit.getDoubleValue() > 0.0);
    }
    ...
    private void resetCustomer() {
        ...
        m_jDeposit.setDoubleValue(null);
    ...
    private void initComponents() {
        ...
        m_jDeposit = new uk.chromis.editor.JEditorCurrency();
        ...
        btnPay.setMaximumSize(new java.awt.Dimension(180, 44));
        btnPay.setMinimumSize(new java.awt.Dimension(180, 44));
        btnPay.setPreferredSize(new java.awt.Dimension(180, 44));
        ...
        jLabel8.setText(AppLocal.getIntString("label.deposit"));

        m_jDeposit.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                m_jDepositInputMethodTextChanged(evt);
            }
        });
        m_jDeposit.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                m_jDepositKeyTyped(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(m_jDeposit, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(m_jDeposit, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnPayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPayActionPerformed
        ...
        if (m_jDeposit.getDoubleValue() <= 0) {
            JOptionPane.showMessageDialog(null, "Bitte Einzahlungsbetrag eingeben", "Hinweis", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
...
//        if (paymentdialog.showDialog(customerext.getCurdebt(), null)) {
        if (paymentdialog.showDialog(m_jDeposit.getDoubleValue(), null)) {
    ...
    private void m_jDepositInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_m_jDepositInputMethodTextChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_m_jDepositInputMethodTextChanged

    private void m_jDepositKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_m_jDepositKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_m_jDepositKeyTyped
    ...
    private uk.chromis.editor.JEditorCurrency m_jDeposit;
