...
public final class CustomersView extends javax.swing.JPanel implements EditorRecord {
    ...
    public CustomersView(AppView app, DirtyManager dirty, String siteGuid) {
        try {
            ...
            m_TTP = new TicketParser(app.getDeviceTicket(), dlSystem);       
            initComponents();
    ...
    private void initComponents() {
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uk/chromis/images/printer.png"))); // NOI18N
        jButton4.setToolTipText(bundle.getString("tiptext.clearkey")); // NOI18N
        jButton4.setMaximumSize(new java.awt.Dimension(64, 32));
        jButton4.setMinimumSize(new java.awt.Dimension(64, 32));
    ...
    private void printTicket() {    
        String sresource = dlSystem.getResourceAsXML("Printer.Customer");
        if (sresource == null) {
            MessageInf msg = new MessageInf(MessageInf.SGN_WARNING, AppLocal.getIntString("message.cannotprintticket"));
            msg.show(CustomersView.this);
        } else {
            m_Customer = new CustomerInfoExt(m_jTaxID.getText());
            m_Customer.setFirstname(txtFirstName.getText());
            m_Customer.setLastname(txtLastName.getText());
            m_Customer.setName(m_jName.getText());
            m_Customer.setCard(jcard.getText());
            try {
                ScriptEngine script = ScriptFactory.getScriptEngine(ScriptFactory.VELOCITY);
                script.put("customer", m_Customer);
